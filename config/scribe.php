...
return [
  ...
  INTRO,
    ...
    /*
     * Text to place in the "Introduccion" section, right after the `description`. Markdown and HTML are supported.
     */
    'description' => 'Esta API de precios responde una lista de precios asociada a un producto con su codigo, descripción y estado, también con sus respectivos margenes y diferentes precios',
    'intro_text' => <<<INTRO
